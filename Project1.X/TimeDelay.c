...
void Delay_ms(uint16_t time_ms){
    ...
    //if required time parameter is 1 second (1000 ms))
    if(time_ms == 1000){
        //clock divide by 8
        T2CONbits.TCKPS0 = 0;           //PR2*2/FCLK*PRESCALER = DELAY(ms) ... PR2*2*Tclk*prescaler = delay 
        T2CONbits.TCKPS1 = 1;           //PR2*2*(0.000125)*8 = 1000 -> thus, PR2 = 500000 *3 (3-scale trial and error))
        //PR2 for 1000 ms delay
       // PR2 = 900000;
       // PR2 = (int)15625; 
        PR2 = (int)1500000;         
    }
    //if required delay is 2 seconds (2000 ms))
    else if(time_ms == 2000){           //PR2*2*0.000125*256 = 2000 ... pr2 = 31250
        //clock division by 256
        T2CONbits.TCKPS0 = 1;
        T2CONbits.TCKPS1 = 1;
        //PR2 = 1000000;
       // PR2 = 31250;
        //necessary PR2 for 2000 ms delay
        //PR2 = 20250;
        PR2 = (int)31250;
    }
    //if 3000 ms delay required
    else if(time_ms == 3000){
        //set clock division to 256             //PR2* 2 * 0.000125*256 = 3000...PR2 = 46875
        T2CONbits.TCKPS0 = 1;
        T2CONbits.TCKPS1 = 1;
        //PR2 = 1500000;
        //necessary PR2 to achieve the delay
        //PR2 = 30000;
       PR2 = (int)46875;
    }
...
void __attribute__((interrupt,no_auto_psv))_T2Interrupt(void){
    ...
    IFS0bits.T2IF = 0;
    //T2CONbits.TON = 0;
    //turn LED on if flag1==0, then turn flag1 high
    if(flag1 == 0){
        LATBbits.LATB8 = 1;
        flag1 = 1;
    }
